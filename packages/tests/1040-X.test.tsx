...
import 1040-XInterview from '../packages/ui/src/components/1040-X/Interview';
import 1040-XForm from '../packages/ui/src/components/1040-X/Form';
import 1040-xReducer from '../packages/ui/src/store/slices/1040-xSlice';
...
describe('Form 1040-X', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1040-X')).toBeInTheDocument();
    });
