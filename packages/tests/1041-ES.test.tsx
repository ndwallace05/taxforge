...
import 1041-ESInterview from '../packages/ui/src/components/1041-ES/Interview';
import 1041-ESForm from '../packages/ui/src/components/1041-ES/Form';
import 1041-esReducer from '../packages/ui/src/store/slices/1041-esSlice';
...
describe('Form 1041-ES', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1041-ES')).toBeInTheDocument();
    });
