...
import 8865Interview from '../packages/ui/src/components/8865/Interview';
import 8865Form from '../packages/ui/src/components/8865/Form';
import 8865Reducer from '../packages/ui/src/store/slices/8865Slice';
...
describe('Form 8865', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8865')).toBeInTheDocument();
    });
