...
import Schedule-FInterview from '../packages/ui/src/components/Schedule-F/Interview';
import Schedule-FForm from '../packages/ui/src/components/Schedule-F/Form';
import schedule-fReducer from '../packages/ui/src/store/slices/schedule-fSlice';
...
describe('Form Schedule-F', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-F')).toBeInTheDocument();
    });
