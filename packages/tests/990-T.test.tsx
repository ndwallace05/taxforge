...
import 990-TInterview from '../packages/ui/src/components/990-T/Interview';
import 990-TForm from '../packages/ui/src/components/990-T/Form';
import 990-tReducer from '../packages/ui/src/store/slices/990-tSlice';
...
describe('Form 990-T', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 990-T')).toBeInTheDocument();
    });
