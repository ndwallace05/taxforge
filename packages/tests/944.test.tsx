...
import 944Interview from '../packages/ui/src/components/944/Interview';
import 944Form from '../packages/ui/src/components/944/Form';
import 944Reducer from '../packages/ui/src/store/slices/944Slice';
...
describe('Form 944', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 944')).toBeInTheDocument();
    });
