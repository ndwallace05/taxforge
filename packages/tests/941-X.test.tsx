...
import 941-XInterview from '../packages/ui/src/components/941-X/Interview';
import 941-XForm from '../packages/ui/src/components/941-X/Form';
import 941-xReducer from '../packages/ui/src/store/slices/941-xSlice';
...
describe('Form 941-X', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 941-X')).toBeInTheDocument();
    });
