...
import Schedule-RInterview from '../packages/ui/src/components/Schedule-R/Interview';
import Schedule-RForm from '../packages/ui/src/components/Schedule-R/Form';
import schedule-rReducer from '../packages/ui/src/store/slices/schedule-rSlice';
...
describe('Form Schedule-R', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-R')).toBeInTheDocument();
    });
