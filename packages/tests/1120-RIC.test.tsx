...
import 1120-RICInterview from '../packages/ui/src/components/1120-RIC/Interview';
import 1120-RICForm from '../packages/ui/src/components/1120-RIC/Form';
import 1120-ricReducer from '../packages/ui/src/store/slices/1120-ricSlice';
...
describe('Form 1120-RIC', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1120-RIC')).toBeInTheDocument();
    });
