...
import 990-EZInterview from '../packages/ui/src/components/990-EZ/Interview';
import 990-EZForm from '../packages/ui/src/components/990-EZ/Form';
import 990-ezReducer from '../packages/ui/src/store/slices/990-ezSlice';
...
describe('Form 990-EZ', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 990-EZ')).toBeInTheDocument();
    });
