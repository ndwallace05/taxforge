...
import Schedule-1Interview from '../packages/ui/src/components/Schedule-1/Interview';
import Schedule-1Form from '../packages/ui/src/components/Schedule-1/Form';
import schedule-1Reducer from '../packages/ui/src/store/slices/schedule-1Slice';
...
describe('Form Schedule-1', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-1')).toBeInTheDocument();
    });
