...
import 1099-INTInterview from '../packages/ui/src/components/1099-INT/Interview';
import 1099-INTForm from '../packages/ui/src/components/1099-INT/Form';
import 1099-intReducer from '../packages/ui/src/store/slices/1099-intSlice';
...
describe('Form 1099-INT', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1099-INT')).toBeInTheDocument();
    });
