...
import 1099-OIDInterview from '../packages/ui/src/components/1099-OID/Interview';
import 1099-OIDForm from '../packages/ui/src/components/1099-OID/Form';
import 1099-oidReducer from '../packages/ui/src/store/slices/1099-oidSlice';
...
describe('Form 1099-OID', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1099-OID')).toBeInTheDocument();
    });
