...
import SS-8Interview from '../packages/ui/src/components/SS-8/Interview';
import SS-8Form from '../packages/ui/src/components/SS-8/Form';
import ss-8Reducer from '../packages/ui/src/store/slices/ss-8Slice';
...
describe('Form SS-8', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form SS-8')).toBeInTheDocument();
    });
