...
import 970Interview from '../packages/ui/src/components/970/Interview';
import 970Form from '../packages/ui/src/components/970/Form';
import 970Reducer from '../packages/ui/src/store/slices/970Slice';
...
describe('Form 970', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 970')).toBeInTheDocument();
    });
