...
import Schedule-SEInterview from '../packages/ui/src/components/Schedule-SE/Interview';
import Schedule-SEForm from '../packages/ui/src/components/Schedule-SE/Form';
import schedule-seReducer from '../packages/ui/src/store/slices/schedule-seSlice';
...
describe('Form Schedule-SE', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-SE')).toBeInTheDocument();
    });
