...
import 8814Interview from '../packages/ui/src/components/8814/Interview';
import 8814Form from '../packages/ui/src/components/8814/Form';
import 8814Reducer from '../packages/ui/src/store/slices/8814Slice';
...
describe('Form 8814', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8814')).toBeInTheDocument();
    });
