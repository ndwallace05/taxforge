...
import 8930Interview from '../packages/ui/src/components/8930/Interview';
import 8930Form from '../packages/ui/src/components/8930/Form';
import 8930Reducer from '../packages/ui/src/store/slices/8930Slice';
...
describe('Form 8930', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8930')).toBeInTheDocument();
    });
