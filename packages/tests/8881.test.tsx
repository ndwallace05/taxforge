...
import 8881Interview from '../packages/ui/src/components/8881/Interview';
import 8881Form from '../packages/ui/src/components/8881/Form';
import 8881Reducer from '../packages/ui/src/store/slices/8881Slice';
...
describe('Form 8881', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8881')).toBeInTheDocument();
    });
