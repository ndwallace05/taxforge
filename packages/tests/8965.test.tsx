...
import 8965Interview from '../packages/ui/src/components/8965/Interview';
import 8965Form from '../packages/ui/src/components/8965/Form';
import 8965Reducer from '../packages/ui/src/store/slices/8965Slice';
...
describe('Form 8965', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8965')).toBeInTheDocument();
    });
