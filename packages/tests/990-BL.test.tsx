...
import 990-BLInterview from '../packages/ui/src/components/990-BL/Interview';
import 990-BLForm from '../packages/ui/src/components/990-BL/Form';
import 990-blReducer from '../packages/ui/src/store/slices/990-blSlice';
...
describe('Form 990-BL', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 990-BL')).toBeInTheDocument();
    });
