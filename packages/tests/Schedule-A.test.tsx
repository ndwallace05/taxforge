...
import Schedule-AInterview from '../packages/ui/src/components/Schedule-A/Interview';
import Schedule-AForm from '../packages/ui/src/components/Schedule-A/Form';
import schedule-aReducer from '../packages/ui/src/store/slices/schedule-aSlice';
...
describe('Form Schedule-A', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-A')).toBeInTheDocument();
    });
