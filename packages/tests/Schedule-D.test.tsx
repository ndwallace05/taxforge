...
import Schedule-DInterview from '../packages/ui/src/components/Schedule-D/Interview';
import Schedule-DForm from '../packages/ui/src/components/Schedule-D/Form';
import schedule-dReducer from '../packages/ui/src/store/slices/schedule-dSlice';
...
describe('Form Schedule-D', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-D')).toBeInTheDocument();
    });
