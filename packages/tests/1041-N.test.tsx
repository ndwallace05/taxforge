...
import 1041-NInterview from '../packages/ui/src/components/1041-N/Interview';
import 1041-NForm from '../packages/ui/src/components/1041-N/Form';
import 1041-nReducer from '../packages/ui/src/store/slices/1041-nSlice';
...
describe('Form 1041-N', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1041-N')).toBeInTheDocument();
    });
