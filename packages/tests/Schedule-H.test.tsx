...
import Schedule-HInterview from '../packages/ui/src/components/Schedule-H/Interview';
import Schedule-HForm from '../packages/ui/src/components/Schedule-H/Form';
import schedule-hReducer from '../packages/ui/src/store/slices/schedule-hSlice';
...
describe('Form Schedule-H', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-H')).toBeInTheDocument();
    });
