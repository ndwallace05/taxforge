...
import CT-2Interview from '../packages/ui/src/components/CT-2/Interview';
import CT-2Form from '../packages/ui/src/components/CT-2/Form';
import ct-2Reducer from '../packages/ui/src/store/slices/ct-2Slice';
...
describe('Form CT-2', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form CT-2')).toBeInTheDocument();
    });
