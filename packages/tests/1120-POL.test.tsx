...
import 1120-POLInterview from '../packages/ui/src/components/1120-POL/Interview';
import 1120-POLForm from '../packages/ui/src/components/1120-POL/Form';
import 1120-polReducer from '../packages/ui/src/store/slices/1120-polSlice';
...
describe('Form 1120-POL', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1120-POL')).toBeInTheDocument();
    });
