...
import Schedule-2Interview from '../packages/ui/src/components/Schedule-2/Interview';
import Schedule-2Form from '../packages/ui/src/components/Schedule-2/Form';
import schedule-2Reducer from '../packages/ui/src/store/slices/schedule-2Slice';
...
describe('Form Schedule-2', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-2')).toBeInTheDocument();
    });
