...
import 8948Interview from '../packages/ui/src/components/8948/Interview';
import 8948Form from '../packages/ui/src/components/8948/Form';
import 8948Reducer from '../packages/ui/src/store/slices/8948Slice';
...
describe('Form 8948', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8948')).toBeInTheDocument();
    });
