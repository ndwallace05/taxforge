...
import Schedule-CInterview from '../packages/ui/src/components/Schedule-C/Interview';
import Schedule-CForm from '../packages/ui/src/components/Schedule-C/Form';
import schedule-cReducer from '../packages/ui/src/store/slices/schedule-cSlice';
...
describe('Form Schedule-C', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-C')).toBeInTheDocument();
    });
