...
import 8606Interview from '../packages/ui/src/components/8606/Interview';
import 8606Form from '../packages/ui/src/components/8606/Form';
import 8606Reducer from '../packages/ui/src/store/slices/8606Slice';
...
describe('Form 8606', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8606')).toBeInTheDocument();
    });
