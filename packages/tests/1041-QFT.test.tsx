...
import 1041-QFTInterview from '../packages/ui/src/components/1041-QFT/Interview';
import 1041-QFTForm from '../packages/ui/src/components/1041-QFT/Form';
import 1041-qftReducer from '../packages/ui/src/store/slices/1041-qftSlice';
...
describe('Form 1041-QFT', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1041-QFT')).toBeInTheDocument();
    });
