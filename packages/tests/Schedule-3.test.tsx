...
import Schedule-3Interview from '../packages/ui/src/components/Schedule-3/Interview';
import Schedule-3Form from '../packages/ui/src/components/Schedule-3/Form';
import schedule-3Reducer from '../packages/ui/src/store/slices/schedule-3Slice';
...
describe('Form Schedule-3', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-3')).toBeInTheDocument();
    });
