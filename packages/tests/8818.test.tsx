...
import 8818Interview from '../packages/ui/src/components/8818/Interview';
import 8818Form from '../packages/ui/src/components/8818/Form';
import 8818Reducer from '../packages/ui/src/store/slices/8818Slice';
...
describe('Form 8818', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8818')).toBeInTheDocument();
    });
