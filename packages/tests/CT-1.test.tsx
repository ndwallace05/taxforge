...
import CT-1Interview from '../packages/ui/src/components/CT-1/Interview';
import CT-1Form from '../packages/ui/src/components/CT-1/Form';
import ct-1Reducer from '../packages/ui/src/store/slices/ct-1Slice';
...
describe('Form CT-1', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form CT-1')).toBeInTheDocument();
    });
