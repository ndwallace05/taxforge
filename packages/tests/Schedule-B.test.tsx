...
import Schedule-BInterview from '../packages/ui/src/components/Schedule-B/Interview';
import Schedule-BForm from '../packages/ui/src/components/Schedule-B/Form';
import schedule-bReducer from '../packages/ui/src/store/slices/schedule-bSlice';
...
describe('Form Schedule-B', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-B')).toBeInTheDocument();
    });
