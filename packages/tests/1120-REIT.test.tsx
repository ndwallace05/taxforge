...
import 1120-REITInterview from '../packages/ui/src/components/1120-REIT/Interview';
import 1120-REITForm from '../packages/ui/src/components/1120-REIT/Form';
import 1120-reitReducer from '../packages/ui/src/store/slices/1120-reitSlice';
...
describe('Form 1120-REIT', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1120-REIT')).toBeInTheDocument();
    });
