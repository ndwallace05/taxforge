...
import 1098Interview from '../packages/ui/src/components/1098/Interview';
import 1098Form from '../packages/ui/src/components/1098/Form';
import 1098Reducer from '../packages/ui/src/store/slices/1098Slice';
...
describe('Form 1098', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1098')).toBeInTheDocument();
    });
