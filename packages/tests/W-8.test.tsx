...
import W-8Interview from '../packages/ui/src/components/W-8/Interview';
import W-8Form from '../packages/ui/src/components/W-8/Form';
import w-8Reducer from '../packages/ui/src/store/slices/w-8Slice';
...
describe('Form W-8', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form W-8')).toBeInTheDocument();
    });
