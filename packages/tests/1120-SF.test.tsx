...
import 1120-SFInterview from '../packages/ui/src/components/1120-SF/Interview';
import 1120-SFForm from '../packages/ui/src/components/1120-SF/Form';
import 1120-sfReducer from '../packages/ui/src/store/slices/1120-sfSlice';
...
describe('Form 1120-SF', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1120-SF')).toBeInTheDocument();
    });
