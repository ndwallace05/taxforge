...
import 8955-SSAInterview from '../packages/ui/src/components/8955-SSA/Interview';
import 8955-SSAForm from '../packages/ui/src/components/8955-SSA/Form';
import 8955-ssaReducer from '../packages/ui/src/store/slices/8955-ssaSlice';
...
describe('Form 8955-SSA', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 8955-SSA')).toBeInTheDocument();
    });
