...
import 1098-FInterview from '../packages/ui/src/components/1098-F/Interview';
import 1098-FForm from '../packages/ui/src/components/1098-F/Form';
import 1098-fReducer from '../packages/ui/src/store/slices/1098-fSlice';
...
describe('Form 1098-F', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1098-F')).toBeInTheDocument();
    });
