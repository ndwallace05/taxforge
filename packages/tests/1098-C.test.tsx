...
import 1098-CInterview from '../packages/ui/src/components/1098-C/Interview';
import 1098-CForm from '../packages/ui/src/components/1098-C/Form';
import 1098-cReducer from '../packages/ui/src/store/slices/1098-cSlice';
...
describe('Form 1098-C', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form 1098-C')).toBeInTheDocument();
    });
