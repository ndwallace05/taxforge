...
import Schedule-EICInterview from '../packages/ui/src/components/Schedule-EIC/Interview';
import Schedule-EICForm from '../packages/ui/src/components/Schedule-EIC/Form';
import schedule-eicReducer from '../packages/ui/src/store/slices/schedule-eicSlice';
...
describe('Form Schedule-EIC', () => {
  ...
  describe('Form Component', () => {
    it('renders form structure correctly', () => {
      ...
      expect(screen.getByText('Form Schedule-EIC')).toBeInTheDocument();
    });
