...
export const useCalculated1040NR = () => {
    ...
    return useMemo(() => {
        ...
        const totalEffectivelyConnectedIncome = formData['1040NR_line_1a'] +
        ...
        const totalAdjustments = formData['1040NR_line_10a'] +
        ...
        const totalNECIncome = formData['scheduleNEC_line_1'] +
        ...
        const totalPayments = formData['1040NR_line_21'] +
        ...
        const substantialPresenceDays = formData['scheduleOI_days_present_current_year'] +
        ...
        // Treaty Benefits
        const treatyBenefitsApplicable = formData['scheduleOI_treaty_benefits'] &&
        ...
        const requiresScheduleOI = treatyBenefitsApplicable ||
