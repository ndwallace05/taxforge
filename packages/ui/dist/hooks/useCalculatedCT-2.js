...
import { z } from 'zod';
import { setCalculatedValue, selectCT } from -2;
Values;
from;
...
() => {
    ...
    return {
        validate: (data) => CT - 2, Schema, : .safeParse(data),
        isValid: CT - 2, Schema, : .safeParse(values).success
    };
};
