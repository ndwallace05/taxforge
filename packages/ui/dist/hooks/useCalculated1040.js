...
export const useCalculated1040 = () => {
    ...
    return {
        ...
        '1040_line_24': ((data['1040_line_1a'] || 0) +
            (data['1040_line_1b'] || 0) +
            (data['1040_line_2a'] || 0) +
            (data['1040_line_2b'] || 0) +
            (data['1040_line_3a'] || 0) +
        ...
        '1040_line_33': ((data['1040_line_25a'] || 0) +
        ...
        '1040_line_35': Math.max(0, (data['1040_line_24'] || 0) - (data['1040_line_33'] || 0)) + (data['1040_line_34'] || 0),
        // Line 36: Estimated tax penalty
        '1040_line_36': (data['1040_line_34'] || 0),
        // Line 37: Amount you owe (line 35 + line 36)
        '1040_line_37': (data['1040_line_35'] || 0),
