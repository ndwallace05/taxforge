...
import form1040Reducer from '../../../store/slices/form1040Slice';
// Mock store setup
...
describe('Form1040 – 100% Line Coverage', () => {
    it('renders form header with title and subtitle', () => {
        renderWithProvider(_jsx(Form1040, {}));
    ...
    it('handles readonly mode correctly', () => {
        renderWithProvider(_jsx(Form1040, { readonly: true }));
    ...
    it('displays errors when present', () => {
        ...
        renderWithProvider(_jsx(Form1040, {}), storeWithErrors);
    ...
    it('calculates auto-computed values correctly', () => {
        ...
        renderWithProvider(_jsx(Form1040, {}), storeWithData);
    ...
    it('supports all filing status options', () => {
        ...
        filingStatuses.forEach(status => {
            ...
            const { unmount } = renderWithProvider(_jsx(Form1040, {}), store);
    ...
    it('handles form submission', async () => {
        ...
        renderWithProvider(_jsx(Form1040, { onSubmit: mockOnSubmit }), completeStore);
...
describe('useCalculated1040 Hook', () => {
    it('calculates line 9 correctly (line 7 + line 8)', () => {
        ...
        renderWithProvider(_jsx(Form1040, {}), store);
