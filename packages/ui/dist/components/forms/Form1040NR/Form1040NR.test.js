...
const renderWithProvider = (component, store = createTestStore()) => {
    return render(_jsx(Provider, { store: store, children: component }));
};
describe('Form1040NR', () => {
    beforeEach(() => {
    ...
    describe('Rendering', () => {
        it('renders the form with initial step', () => {
            renderWithProvider(_jsx(Form1040NR, {}));
    ...
    describe('Navigation', () => {
        it('navigates to next step when Next is clicked', async () => {
            ...
            renderWithProvider(_jsx(Form1040NR, {}), store);
    ...
    describe('Form Validation', () => {
        it('displays validation errors', () => {
            ...
            renderWithProvider(_jsx(Form1040NR, {}), storeWithErrors);
    ...
    describe('Nonresident Alien Specific Features', () => {
        it('displays substantial presence test warning', () => {
            ...
            renderWithProvider(_jsx(Form1040NR, {}), storeWithManyDays);
        ...
        it('shows treaty benefits section when applicable', () => {
            ...
            renderWithProvider(_jsx(Form1040NR, {}), storeWithTreaty);
    ...
    describe('Error Handling', () => {
        it('handles loading state', () => {
            ...
            renderWithProvider(_jsx(Form1040NR, {}), loadingStore);
