...
const renderWithProvider = (component, initialState = {}) => {
    ...
    return {
        ...render(_jsx(Provider, { store: store, children: component })),
        store
    };
};
describe('Form1040SR', () => {
    ...
    it('renders the form with initial step', () => {
        renderWithProvider(_jsx(Form1040SR, {}));
    ...
    it('displays tax calculations', () => {
        ...
        renderWithProvider(_jsx(Form1040SR, {}), initialState);
    ...
    it('handles form submission', async () => {
        ...
        renderWithProvider(_jsx(Form1040SR, { onSubmit: mockOnSubmit }));
...
describe('Form1040SR Integration', () => {
    ...
    it('handles complex tax scenarios', () => {
        const complexScenario = {
            '1040SR_line_1a': 75000,
            '1040SR_line_2b': 10000,
            '1040SR_line_3b': 5000,
            '1040SR_line_4b': 20000,
            '1040SR_line_5b': 30000,
            '1040SR_line_6b': 15000,
            age65OrOlder: true,
            filingStatus: 'marriedFilingJointly',
            spouseAge65OrOlder: true
        };
        renderWithProvider(_jsx(Form1040SR, {}), complexScenario);
