...
interface 5310FormProps {
  printMode?: boolean;
}

export const 5310Form: React.FC<5310FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5310Values);

  return (
    <div className={`form-5310 ${printMode ? 'print-mode' : ''}`}>
