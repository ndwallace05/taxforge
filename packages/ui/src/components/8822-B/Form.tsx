...
import { select8822-BValues } from '../../store/slices/8822-bSlice';

interface 8822-BFormProps {
  printMode?: boolean;
}

export const 8822-BForm: React.FC<8822-BFormProps> = ({ printMode = false }) => {
  const values = useSelector(select8822-BValues);

  return (
    <div className={`form-8822-b ${printMode ? 'print-mode' : ''}`}>
