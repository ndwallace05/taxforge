...
interface 8862FormProps {
  printMode?: boolean;
}

export const 8862Form: React.FC<8862FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8862Values);

  return (
    <div className={`form-8862 ${printMode ? 'print-mode' : ''}`}>
