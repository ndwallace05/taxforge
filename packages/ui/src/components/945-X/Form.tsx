...
import { select945-XValues } from '../../store/slices/945-xSlice';

interface 945-XFormProps {
  printMode?: boolean;
}

export const 945-XForm: React.FC<945-XFormProps> = ({ printMode = false }) => {
  const values = useSelector(select945-XValues);

  return (
    <div className={`form-945-x ${printMode ? 'print-mode' : ''}`}>
