...
import { select1099-OIDValues } from '../../store/slices/1099-oidSlice';

interface 1099-OIDFormProps {
  printMode?: boolean;
}

export const 1099-OIDForm: React.FC<1099-OIDFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1099-OIDValues);

  return (
    <div className={`form-1099-oid ${printMode ? 'print-mode' : ''}`}>
