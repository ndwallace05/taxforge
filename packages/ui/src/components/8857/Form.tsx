...
interface 8857FormProps {
  printMode?: boolean;
}

export const 8857Form: React.FC<8857FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8857Values);

  return (
    <div className={`form-8857 ${printMode ? 'print-mode' : ''}`}>
