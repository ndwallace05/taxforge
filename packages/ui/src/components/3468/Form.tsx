...
import { select3468Values } from '../../store/slices/3468Slice';

interface 3468FormProps {
  printMode?: boolean;
}

export const 3468Form: React.FC<3468FormProps> = ({ printMode = false }) => {
  const values = useSelector(select3468Values);

  return (
    <div className={`form-3468 ${printMode ? 'print-mode' : ''}`}>
