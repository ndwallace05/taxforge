...
import { select990-BLValues } from '../../store/slices/990-blSlice';

interface 990-BLFormProps {
  printMode?: boolean;
}

export const 990-BLForm: React.FC<990-BLFormProps> = ({ printMode = false }) => {
  const values = useSelector(select990-BLValues);

  return (
    <div className={`form-990-bl ${printMode ? 'print-mode' : ''}`}>
