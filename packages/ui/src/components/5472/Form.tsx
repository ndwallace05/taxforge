...
interface 5472FormProps {
  printMode?: boolean;
}

export const 5472Form: React.FC<5472FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5472Values);

  return (
    <div className={`form-5472 ${printMode ? 'print-mode' : ''}`}>
