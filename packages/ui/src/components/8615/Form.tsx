...
interface 8615FormProps {
  printMode?: boolean;
}

export const 8615Form: React.FC<8615FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8615Values);

  return (
    <div className={`form-8615 ${printMode ? 'print-mode' : ''}`}>
