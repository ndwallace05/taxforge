...
interface 944InterviewProps {
  onComplete?: () => void;
}

export const 944Interview: React.FC<944InterviewProps> = ({ onComplete }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Form 944 Interview</h1>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            aria-label="Sample input for Form 944"
          />
        </div>
      </div>
