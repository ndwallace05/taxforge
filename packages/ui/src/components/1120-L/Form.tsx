...
import { select1120-LValues } from '../../store/slices/1120-lSlice';

interface 1120-LFormProps {
  printMode?: boolean;
}

export const 1120-LForm: React.FC<1120-LFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1120-LValues);

  return (
    <div className={`form-1120-l ${printMode ? 'print-mode' : ''}`}>
