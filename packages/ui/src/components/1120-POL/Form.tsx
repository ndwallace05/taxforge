...
import { select1120-POLValues } from '../../store/slices/1120-polSlice';

interface 1120-POLFormProps {
  printMode?: boolean;
}

export const 1120-POLForm: React.FC<1120-POLFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1120-POLValues);

  return (
    <div className={`form-1120-pol ${printMode ? 'print-mode' : ''}`}>
