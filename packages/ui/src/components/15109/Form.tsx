...
interface 15109FormProps {
  printMode?: boolean;
}

export const 15109Form: React.FC<15109FormProps> = ({ printMode = false }) => {
  const values = useSelector(select15109Values);

  return (
    <div className={`form-15109 ${printMode ? 'print-mode' : ''}`}>
