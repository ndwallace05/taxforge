...
import { select1098-CValues } from '../../store/slices/1098-cSlice';

interface 1098-CFormProps {
  printMode?: boolean;
}

export const 1098-CForm: React.FC<1098-CFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1098-CValues);

  return (
    <div className={`form-1098-c ${printMode ? 'print-mode' : ''}`}>
