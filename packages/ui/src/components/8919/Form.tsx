...
interface 8919FormProps {
  printMode?: boolean;
}

export const 8919Form: React.FC<8919FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8919Values);

  return (
    <div className={`form-8919 ${printMode ? 'print-mode' : ''}`}>
