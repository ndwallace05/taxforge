...
import { select1065-BValues } from '../../store/slices/1065-bSlice';

interface 1065-BFormProps {
  printMode?: boolean;
}

export const 1065-BForm: React.FC<1065-BFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1065-BValues);

  return (
    <div className={`form-1065-b ${printMode ? 'print-mode' : ''}`}>
