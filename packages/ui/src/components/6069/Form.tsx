...
interface 6069FormProps {
  printMode?: boolean;
}

export const 6069Form: React.FC<6069FormProps> = ({ printMode = false }) => {
  const values = useSelector(select6069Values);

  return (
    <div className={`form-6069 ${printMode ? 'print-mode' : ''}`}>
