...
interface 8853FormProps {
  printMode?: boolean;
}

export const 8853Form: React.FC<8853FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8853Values);

  return (
    <div className={`form-8853 ${printMode ? 'print-mode' : ''}`}>
