...
interface 2210FormProps {
  printMode?: boolean;
}

export const 2210Form: React.FC<2210FormProps> = ({ printMode = false }) => {
  const values = useSelector(select2210Values);

  return (
    <div className={`form-2210 ${printMode ? 'print-mode' : ''}`}>
