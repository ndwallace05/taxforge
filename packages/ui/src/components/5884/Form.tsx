...
interface 5884FormProps {
  printMode?: boolean;
}

export const 5884Form: React.FC<5884FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5884Values);

  return (
    <div className={`form-5884 ${printMode ? 'print-mode' : ''}`}>
