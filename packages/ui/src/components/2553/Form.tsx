...
interface 2553FormProps {
  printMode?: boolean;
}

export const 2553Form: React.FC<2553FormProps> = ({ printMode = false }) => {
  const values = useSelector(select2553Values);

  return (
    <div className={`form-2553 ${printMode ? 'print-mode' : ''}`}>
