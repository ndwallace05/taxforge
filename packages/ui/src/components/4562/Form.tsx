...
interface 4562FormProps {
  printMode?: boolean;
}

export const 4562Form: React.FC<4562FormProps> = ({ printMode = false }) => {
  const values = useSelector(select4562Values);

  return (
    <div className={`form-4562 ${printMode ? 'print-mode' : ''}`}>
