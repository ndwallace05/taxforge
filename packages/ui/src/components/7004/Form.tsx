...
interface 7004FormProps {
  printMode?: boolean;
}

export const 7004Form: React.FC<7004FormProps> = ({ printMode = false }) => {
  const values = useSelector(select7004Values);

  return (
    <div className={`form-7004 ${printMode ? 'print-mode' : ''}`}>
