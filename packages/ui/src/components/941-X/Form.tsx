...
import { select941-XValues } from '../../store/slices/941-xSlice';

interface 941-XFormProps {
  printMode?: boolean;
}

export const 941-XForm: React.FC<941-XFormProps> = ({ printMode = false }) => {
  const values = useSelector(select941-XValues);

  return (
    <div className={`form-941-x ${printMode ? 'print-mode' : ''}`}>
