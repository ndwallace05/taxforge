...
interface 1041FormProps {
  printMode?: boolean;
}

export const 1041Form: React.FC<1041FormProps> = ({ printMode = false }) => {
  const values = useSelector(select1041Values);

  return (
    <div className={`form-1041 ${printMode ? 'print-mode' : ''}`}>
