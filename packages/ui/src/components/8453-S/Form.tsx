...
import { select8453-SValues } from '../../store/slices/8453-sSlice';

interface 8453-SFormProps {
  printMode?: boolean;
}

export const 8453-SForm: React.FC<8453-SFormProps> = ({ printMode = false }) => {
  const values = useSelector(select8453-SValues);

  return (
    <div className={`form-8453-s ${printMode ? 'print-mode' : ''}`}>
