...
interface 8965FormProps {
  printMode?: boolean;
}

export const 8965Form: React.FC<8965FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8965Values);

  return (
    <div className={`form-8965 ${printMode ? 'print-mode' : ''}`}>
