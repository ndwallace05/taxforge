...
import { select1098-TValues } from '../../store/slices/1098-tSlice';

interface 1098-TFormProps {
  printMode?: boolean;
}

export const 1098-TForm: React.FC<1098-TFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1098-TValues);

  return (
    <div className={`form-1098-t ${printMode ? 'print-mode' : ''}`}>
