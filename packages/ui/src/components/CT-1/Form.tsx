...
import { selectCT-1Values } from '../../store/slices/ct-1Slice';

interface CT-1FormProps {
  printMode?: boolean;
}

export const CT-1Form: React.FC<CT-1FormProps> = ({ printMode = false }) => {
  const values = useSelector(selectCT-1Values);

  return (
    <div className={`form-ct-1 ${printMode ? 'print-mode' : ''}`}>
