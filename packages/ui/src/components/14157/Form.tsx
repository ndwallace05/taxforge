...
interface 14157FormProps {
  printMode?: boolean;
}

export const 14157Form: React.FC<14157FormProps> = ({ printMode = false }) => {
  const values = useSelector(select14157Values);

  return (
    <div className={`form-14157 ${printMode ? 'print-mode' : ''}`}>
