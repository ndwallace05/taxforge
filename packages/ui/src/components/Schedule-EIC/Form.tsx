...
import { selectSchedule-EICValues } from '../../store/slices/schedule-eicSlice';

interface Schedule-EICFormProps {
  printMode?: boolean;
}

export const Schedule-EICForm: React.FC<Schedule-EICFormProps> = ({ printMode = false }) => {
  const values = useSelector(selectSchedule-EICValues);

  return (
    <div className={`form-schedule-eic ${printMode ? 'print-mode' : ''}`}>
      <div className="form-header">
        <h1>Form Schedule-EIC</h1>
