...
import { select1099-BValues } from '../../store/slices/1099-bSlice';

interface 1099-BFormProps {
  printMode?: boolean;
}

export const 1099-BForm: React.FC<1099-BFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1099-BValues);

  return (
    <div className={`form-1099-b ${printMode ? 'print-mode' : ''}`}>
