...
import { select1120-FValues } from '../../store/slices/1120-fSlice';

interface 1120-FFormProps {
  printMode?: boolean;
}

export const 1120-FForm: React.FC<1120-FFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1120-FValues);

  return (
    <div className={`form-1120-f ${printMode ? 'print-mode' : ''}`}>
