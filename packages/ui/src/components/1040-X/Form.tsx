...
import { select1040-XValues } from '../../store/slices/1040-xSlice';

interface 1040-XFormProps {
  printMode?: boolean;
}

export const 1040-XForm: React.FC<1040-XFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1040-XValues);

  return (
    <div className={`form-1040-x ${printMode ? 'print-mode' : ''}`}>
