...
import { select8879-CValues } from '../../store/slices/8879-cSlice';

interface 8879-CFormProps {
  printMode?: boolean;
}

export const 8879-CForm: React.FC<8879-CFormProps> = ({ printMode = false }) => {
  const values = useSelector(select8879-CValues);

  return (
    <div className={`form-8879-c ${printMode ? 'print-mode' : ''}`}>
