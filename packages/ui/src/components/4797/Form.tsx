...
interface 4797FormProps {
  printMode?: boolean;
}

export const 4797Form: React.FC<4797FormProps> = ({ printMode = false }) => {
  const values = useSelector(select4797Values);

  return (
    <div className={`form-4797 ${printMode ? 'print-mode' : ''}`}>
