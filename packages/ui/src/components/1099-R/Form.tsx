...
import { select1099-RValues } from '../../store/slices/1099-rSlice';

interface 1099-RFormProps {
  printMode?: boolean;
}

export const 1099-RForm: React.FC<1099-RFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1099-RValues);

  return (
    <div className={`form-1099-r ${printMode ? 'print-mode' : ''}`}>
