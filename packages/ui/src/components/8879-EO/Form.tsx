...
import { select8879-EOValues } from '../../store/slices/8879-eoSlice';

interface 8879-EOFormProps {
  printMode?: boolean;
}

export const 8879-EOForm: React.FC<8879-EOFormProps> = ({ printMode = false }) => {
  const values = useSelector(select8879-EOValues);

  return (
    <div className={`form-8879-eo ${printMode ? 'print-mode' : ''}`}>
