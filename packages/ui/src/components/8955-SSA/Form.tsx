...
import { select8955-SSAValues } from '../../store/slices/8955-ssaSlice';

interface 8955-SSAFormProps {
  printMode?: boolean;
}

export const 8955-SSAForm: React.FC<8955-SSAFormProps> = ({ printMode = false }) => {
  const values = useSelector(select8955-SSAValues);

  return (
    <div className={`form-8955-ssa ${printMode ? 'print-mode' : ''}`}>
