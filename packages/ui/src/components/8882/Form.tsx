...
interface 8882FormProps {
  printMode?: boolean;
}

export const 8882Form: React.FC<8882FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8882Values);

  return (
    <div className={`form-8882 ${printMode ? 'print-mode' : ''}`}>
