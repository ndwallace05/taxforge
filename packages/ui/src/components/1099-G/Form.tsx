...
import { select1099-GValues } from '../../store/slices/1099-gSlice';

interface 1099-GFormProps {
  printMode?: boolean;
}

export const 1099-GForm: React.FC<1099-GFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1099-GValues);

  return (
    <div className={`form-1099-g ${printMode ? 'print-mode' : ''}`}>
