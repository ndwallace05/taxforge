...
interface 8917FormProps {
  printMode?: boolean;
}

export const 8917Form: React.FC<8917FormProps> = ({ printMode = false }) => {
  const values = useSelector(select8917Values);

  return (
    <div className={`form-8917 ${printMode ? 'print-mode' : ''}`}>
