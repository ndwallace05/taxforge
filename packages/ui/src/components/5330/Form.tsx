...
interface 5330FormProps {
  printMode?: boolean;
}

export const 5330Form: React.FC<5330FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5330Values);

  return (
    <div className={`form-5330 ${printMode ? 'print-mode' : ''}`}>
