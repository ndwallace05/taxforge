...
interface 5471FormProps {
  printMode?: boolean;
}

export const 5471Form: React.FC<5471FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5471Values);

  return (
    <div className={`form-5471 ${printMode ? 'print-mode' : ''}`}>
