...
import { selectSS-8Values } from '../../store/slices/ss-8Slice';

interface SS-8FormProps {
  printMode?: boolean;
}

export const SS-8Form: React.FC<SS-8FormProps> = ({ printMode = false }) => {
  const values = useSelector(selectSS-8Values);

  return (
    <div className={`form-ss-8 ${printMode ? 'print-mode' : ''}`}>
