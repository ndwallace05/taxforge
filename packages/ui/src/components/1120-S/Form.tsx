...
import { select1120-SValues } from '../../store/slices/1120-sSlice';

interface 1120-SFormProps {
  printMode?: boolean;
}

export const 1120-SForm: React.FC<1120-SFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1120-SValues);

  return (
    <div className={`form-1120-s ${printMode ? 'print-mode' : ''}`}>
