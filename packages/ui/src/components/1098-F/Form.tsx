...
import { select1098-FValues } from '../../store/slices/1098-fSlice';

interface 1098-FFormProps {
  printMode?: boolean;
}

export const 1098-FForm: React.FC<1098-FFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1098-FValues);

  return (
    <div className={`form-1098-f ${printMode ? 'print-mode' : ''}`}>
