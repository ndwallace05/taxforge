...
import { selectW-9Values } from '../../store/slices/w-9Slice';

interface W-9FormProps {
  printMode?: boolean;
}

export const W-9Form: React.FC<W-9FormProps> = ({ printMode = false }) => {
  const values = useSelector(selectW-9Values);

  return (
    <div className={`form-w-9 ${printMode ? 'print-mode' : ''}`}>
