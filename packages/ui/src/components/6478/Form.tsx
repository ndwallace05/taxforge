...
interface 6478FormProps {
  printMode?: boolean;
}

export const 6478Form: React.FC<6478FormProps> = ({ printMode = false }) => {
  const values = useSelector(select6478Values);

  return (
    <div className={`form-6478 ${printMode ? 'print-mode' : ''}`}>
