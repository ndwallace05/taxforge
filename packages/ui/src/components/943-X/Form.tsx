...
import { select943-XValues } from '../../store/slices/943-xSlice';

interface 943-XFormProps {
  printMode?: boolean;
}

export const 943-XForm: React.FC<943-XFormProps> = ({ printMode = false }) => {
  const values = useSelector(select943-XValues);

  return (
    <div className={`form-943-x ${printMode ? 'print-mode' : ''}`}>
