...
interface 2350FormProps {
  printMode?: boolean;
}

export const 2350Form: React.FC<2350FormProps> = ({ printMode = false }) => {
  const values = useSelector(select2350Values);

  return (
    <div className={`form-2350 ${printMode ? 'print-mode' : ''}`}>
