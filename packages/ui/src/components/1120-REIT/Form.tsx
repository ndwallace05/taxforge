...
import { select1120-REITValues } from '../../store/slices/1120-reitSlice';

interface 1120-REITFormProps {
  printMode?: boolean;
}

export const 1120-REITForm: React.FC<1120-REITFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1120-REITValues);

  return (
    <div className={`form-1120-reit ${printMode ? 'print-mode' : ''}`}>
      <div className="form-header">
        <h1>Form 1120-REIT</h1>
