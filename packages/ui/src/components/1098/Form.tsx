...
interface 1098FormProps {
  printMode?: boolean;
}

export const 1098Form: React.FC<1098FormProps> = ({ printMode = false }) => {
  const values = useSelector(select1098Values);

  return (
    <div className={`form-1098 ${printMode ? 'print-mode' : ''}`}>
