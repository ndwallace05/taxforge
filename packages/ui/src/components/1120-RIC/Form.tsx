...
import { select1120-RICValues } from '../../store/slices/1120-ricSlice';

interface 1120-RICFormProps {
  printMode?: boolean;
}

export const 1120-RICForm: React.FC<1120-RICFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1120-RICValues);

  return (
    <div className={`form-1120-ric ${printMode ? 'print-mode' : ''}`}>
