...
interface 5405FormProps {
  printMode?: boolean;
}

export const 5405Form: React.FC<5405FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5405Values);

  return (
    <div className={`form-5405 ${printMode ? 'print-mode' : ''}`}>
