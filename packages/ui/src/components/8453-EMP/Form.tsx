...
import { select8453-EMPValues } from '../../store/slices/8453-empSlice';

interface 8453-EMPFormProps {
  printMode?: boolean;
}

export const 8453-EMPForm: React.FC<8453-EMPFormProps> = ({ printMode = false }) => {
  const values = useSelector(select8453-EMPValues);

  return (
    <div className={`form-8453-emp ${printMode ? 'print-mode' : ''}`}>
