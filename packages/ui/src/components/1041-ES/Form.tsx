...
import { select1041-ESValues } from '../../store/slices/1041-esSlice';

interface 1041-ESFormProps {
  printMode?: boolean;
}

export const 1041-ESForm: React.FC<1041-ESFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1041-ESValues);

  return (
    <div className={`form-1041-es ${printMode ? 'print-mode' : ''}`}>
