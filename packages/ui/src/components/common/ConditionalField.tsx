...
export const ConditionalSection: React.FC<{
  ...
  children: React.ReactNode;
  className?: string;
}> = ({ condition, title, children, className = '' }) => {
  return (
    <ConditionalField condition={condition} className={className}>
...
export const ConditionalAlert: React.FC<{
  condition: boolean;
  type?: 'info' | 'warning' | 'error' | 'success';
  title?: string;
  children: React.ReactNode;
  className?: string;
}> = ({ condition, type = 'info', title, children, className = '' }) => {
...
export const ConditionalHelp: React.FC<{
  condition: boolean;
  children: React.ReactNode;
  className?: string;
...
export const useConditionalField = (initialCondition: boolean = false) => {
