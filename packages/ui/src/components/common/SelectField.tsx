      ...
      {value && options.find(opt => opt.value === value)?.description && (
        <div className="text-sm text-gray-600 bg-blue-50 p-2 rounded border border-blue-200">
          <div className="flex items-start space-x-2">
            ...
            <span>{options.find(opt => opt.value === value)?.description}</span>
          </div>
        </div>
      )}
...
export const FilingStatusSelect: React.FC<Omit<SelectFieldProps, 'options'>> = (props) => {
  ...
  return <SelectField {...props} options={filingStatusOptions} />;
};

export const StateSelect: React.FC<Omit<SelectFieldProps, 'options'>> = (props) => {
  ...
  return <SelectField {...props} options={stateOptions} />;
};
