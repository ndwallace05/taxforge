...
interface 5500FormProps {
  printMode?: boolean;
}

export const 5500Form: React.FC<5500FormProps> = ({ printMode = false }) => {
  const values = useSelector(select5500Values);

  return (
    <div className={`form-5500 ${printMode ? 'print-mode' : ''}`}>
