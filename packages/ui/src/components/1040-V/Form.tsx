...
import { select1040-VValues } from '../../store/slices/1040-vSlice';

interface 1040-VFormProps {
  printMode?: boolean;
}

export const 1040-VForm: React.FC<1040-VFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1040-VValues);

  return (
    <div className={`form-1040-v ${printMode ? 'print-mode' : ''}`}>
