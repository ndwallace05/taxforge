...
import { select1041-QFTValues } from '../../store/slices/1041-qftSlice';

interface 1041-QFTFormProps {
  printMode?: boolean;
}

export const 1041-QFTForm: React.FC<1041-QFTFormProps> = ({ printMode = false }) => {
  const values = useSelector(select1041-QFTValues);

  return (
    <div className={`form-1041-qft ${printMode ? 'print-mode' : ''}`}>
