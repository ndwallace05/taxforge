...
import { z } from 'zod';
import { setCalculatedValue, select990Values } from '../store/slices/990Slice';

// Zod schema for form validation
export const 990Schema = z.object({
...
export const useCalculated990 = () => {
  ...
  return {
    validate: (data: any) => 990Schema.safeParse(data),
    isValid: 990Schema.safeParse(values).success
  };
};
...
export default useCalculated990;
