...
import { z } from 'zod';
import { setCalculatedValue, select945Values } from '../store/slices/945Slice';

// Zod schema for form validation
export const 945Schema = z.object({
...
export const useCalculated945 = () => {
  ...
  return {
    validate: (data: any) => 945Schema.safeParse(data),
    isValid: 945Schema.safeParse(values).success
  };
};
...
export default useCalculated945;
